...
I enjoy turning ideas into <mark><strong>full-stack applications<strong></mark>. From designing clean user experiences to building scalable <mark><strong>backend systems and cloud infrastructure<strong></mark>. Most of what I work on lives at the intersection of web development, distributed systems, and <mark><strong>AWS<strong></mark>.
<p>
...
const filipino = {
  pronouns: "he | him",
  code: [Typescript, NodeJS, NextJS, ReactJS, AWS],
  life: {
          guitar: "beginner",
